          ...
          children: [
            {
              type: 'div',
              props: {
                style: { display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '50%', paddingRight: '10px' },
                children: [
                  { type: 'span', props: { style: { display: 'flex', fontSize: '14px', color: '#444' }, children: izq.producto } },
                  { type: 'span', props: { style: { display: 'flex', fontSize: '14px', color: '#444' }, children: `S/ ${fmtNum(izq.precio)}` } }
                ]
              }
            },
            der ? {
              type: 'div',
              props: {
                style: { display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '50%', paddingLeft: '10px' },
                children: [
                  { type: 'span', props: { style: { display: 'flex', fontSize: '14px', color: '#444' }, children: der.producto } },
                  { type: 'span', props: { style: { display: 'flex', fontSize: '14px', color: '#444' }, children: `S/ ${fmtNum(der.precio)}` } }
                ]
              }
            } : null
          ].filter(Boolean)
  ...
  return new ImageResponse(
    {
      type: 'div',
      props: {
        style: { display: 'flex', flexDirection: 'column', width: '700px', background: '#ffffff', padding: '40px', fontFamily: 'sans-serif' },
        children: [
          { type: 'div', props: { style: { display: 'flex', fontSize: '28px', fontWeight: '800', fontFamily: 'Georgia, serif', marginBottom: '10px' }, children: 'ESTADO DE CUENTA — FIADO' } },
                ...
                children: [
                  {
                    type: 'div',
                    props: {
                      style: { display: 'flex', justifyContent: 'space-between', borderBottom: '2px solid #000', paddingBottom: '5px', marginBottom: '10px' },
                      children: [
          ...
          }),
          {
            type: 'div',
            props: {
              style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f1f3f4', borderRadius: '12px', padding: '25px 30px', marginTop: '20px' },
              children: [
          ...
          { type: 'div', props: { style: { display: 'flex', marginTop: '25px', justifyContent: 'center', fontSize: '15px', color: '#70757a' }, children: 'Gracias por su preferencia 🙌' } }
        ]
      }
    },
    { width: 700 }
